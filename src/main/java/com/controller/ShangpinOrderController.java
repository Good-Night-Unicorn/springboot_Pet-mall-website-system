...
//                            shangpinOrderEntity.setShangpinOrderCourierBeizhu(data.get(0));                    //备注 要改的
    ...
    */
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        Integer addressId = Integer.valueOf(String.valueOf(params.get("addressId")));
            ...
            String shangpinOrderCourierBeizhu = String.valueOf(params.get("shangpinOrderCourierBeizhu"));//备注
        ...
        for (Map<String, Object> map : shangpins) {
           //取值
            ...
            shangpinOrderEntity.setShangpinOrderCourierBeizhu(shangpinOrderCourierBeizhu);//备注 ？？？？？？
...
//            }
    ...
    */
    ...
    public R deliver(Integer id ,String shangpinOrderCourierNumber, String shangpinOrderCourierName ,String shangpinOrderCourierBeizhu , HttpServletRequest request){
        ...
        shangpinOrderEntity.setShangpinOrderCourierBeizhu(shangpinOrderCourierBeizhu);
